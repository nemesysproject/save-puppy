...
export class ShelterController {
    ...
    async create(req: Request, res: Response) {
        try {
            ...
            const command = new CreateShelterCommand(name, email, address, latitude, longitude, capacity);
    ...
    async update(req: Request, res: Response) {
        try {
            const { id } = req.params;
            const { name, email, address, latitude, longitude, capacity } = req.body;
            const command = new UpdateShelterCommand(id, name, email, address, latitude, longitude, capacity);
