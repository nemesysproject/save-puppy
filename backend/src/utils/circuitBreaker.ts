...
export const createBreaker = <T>(
    ...
    breaker.on('halfOpen', () => console.info(`⏳ CIRCUITO SEMI-ABIERTO: ${name} (Probando recuperación)`));
    breaker.on('close', () => console.info(`✅ CIRCUITO CERRADO: ${name} (Servicio recuperado)`));
