...
export class PetFormComponent implements OnInit {
    ...
    private loadLookups(): void {
        this.lookupService.getKinds().subscribe((res: Kind[]) => this.kinds.set(res));
        this.lookupService.getGenders().subscribe((res: Gender[]) => this.genders.set(res));
        this.lookupService.getShelters().subscribe((res: Shelter[]) => this.shelters.set(res));
    }
