...
import {
    pawOutline, businessOutline, alertCircleOutline, heartOutline,
    searchOutline, chevronForwardOutline, refreshOutline
} from 'ionicons/icons';
    ...
    loadData(): void {
        ...
        this.petService.getPets().subscribe({
            next: (pets) => {
                ...
                this.adoptionCount.set(pets.filter(p => p.status === 'ADOPTION').length);
